 ...
 * 自动更新工具
 */
public class AssemblyAutoUpdateUtils {
    private Context context;
    private boolean backGround;

    public AssemblyAutoUpdateUtils(Context uiContext, boolean isbackGround) {
        this.context=uiContext;
        this.backGround=isbackGround;
    }

    public AssemblyAutoUpdateUtils(Context uiContext) {
        this.context=uiContext;
