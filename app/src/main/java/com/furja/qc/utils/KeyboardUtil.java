...
import com.furja.qc.view.NumberKeyBoardView;
...
public class KeyboardUtil {
    ...
    public KeyboardUtil(View fragmentView) {
        this(fragmentView, false);
    }

    public KeyboardUtil(View fragmentView, boolean ifRandom) {
        this.fragmentView = fragmentView;
        this.mIfRandom = ifRandom;
        mKeyboardNumber = new Keyboard(fragmentView.getContext(), R.xml.keyboardnumber);
        mKeyboardView = (NumberKeyBoardView) fragmentView.findViewById(R.id.keyboard_view);
    }
    ...
    public void attachTo(EditText editText) {
        ...
        hideSystemSofeKeyboard(fragmentView.getContext(), mEditText);
        showSoftKeyboard();
    }
