...
public class ColumnChartView extends AbstractChartView implements ColumnChartDataProvider {
    ...
    public void resetViewports() {
        ...
        {
            ColumnChartRenderer columnChartRenderer=(ColumnChartRenderer)getChartRenderer();
            columnChartRenderer.setBaseColumnWidth(0);
            setChartRenderer(columnChartRenderer);
        }
