...
public class ChartComputator {
    ...
    public float computeRawX(float valueX) {
        ...
        final float pixelOffset =
                (valueX - currentViewport.left) * (contentRectMinusAllMargins.width() /
                currentViewport.width());
        return contentRectMinusAllMargins.left + pixelOffset;
    }

    public float computeRawX(int columnIndex, int size) {
        float pixelOffset =
                (columnIndex - currentViewport.left) * (contentRectMinusAllMargins.width() /
                        currentViewport.width());
        return contentRectMinusAllMargins.left + pixelOffset;
    }

    public float computeLabelX(int columnIndex) {
